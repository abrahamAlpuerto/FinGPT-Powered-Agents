FinGPT-Powered Agents Framework: Financial Agents via MCP
=================================================================

Welcome to the documentation for the **FinGPT-Powered Agents Framework**, a modular
architecture designed to facilitate the creation of sophisticated financial agents
through the use of the Model Context Protocol (MCP).
...
market data, user-specific portfolios, remote analytics services, and advanced computational
tools seamlessly into financial agents.
